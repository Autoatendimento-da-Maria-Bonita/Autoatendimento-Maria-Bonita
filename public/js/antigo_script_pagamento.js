document.addEventListener('DOMContentLoaded', () => {
    ...
    for (const [productName, details] of Object.entries(cart)) {
        ...
        item.innerHTML = `
            ...
            <span class="product-quantity" style="text-align:right">${quantity}</span>
            <span class="product-price" style="text-align:right">R$ ${price.toFixed(2)}</span>
            <span class="product-subtotal" style="text-align:right">R$ ${subtotal.toFixed(2)}</span>
        `;
